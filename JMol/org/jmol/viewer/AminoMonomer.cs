...
namespace org.jmol.viewer
{
	...
	{
		virtual internal Atom NitrogenAtom
		{
			get
			{
		...
		virtual internal Point3f NitrogenAtomPoint
		{
			get
			{
		...
		virtual internal Atom CarbonylCarbonAtom
		{
			get
			{
		...
		virtual internal Point3f CarbonylCarbonAtomPoint
		{
			get
			{
		...
		virtual internal Atom CarbonylOxygenAtom
		{
			get
			{
				return WingAtom;
		...
		virtual internal Point3f CarbonylOxygenAtomPoint
		{
			get
			{
				return WingAtomPoint;
			}
			
		}
		override internal Atom InitiatorAtom
		{
			get
			{
				return NitrogenAtom;
		...
		internal static readonly sbyte[] interestingAminoAtomIDs;
		...
		internal static bool isBondedCorrectly(int offset1, int offset2, int firstAtomIndex, sbyte[] offsets, Atom[] atoms)
		{
		...
		internal static bool isBondedCorrectly(int firstAtomIndex, sbyte[] offsets, Atom[] atoms)
		{
		...
		internal AminoMonomer(Chain chain, System.String group3, int seqcode, int firstAtomIndex, int lastAtomIndex, sbyte[] offsets):base(chain, group3, seqcode, firstAtomIndex, lastAtomIndex, offsets)
		{
		}
		
		internal virtual bool isAminoMonomer()
		{
			return true;
		}
