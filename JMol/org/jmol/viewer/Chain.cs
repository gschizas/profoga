...
namespace org.jmol.viewer
{
	...
	sealed class Chain
	{
		...
		internal int SelectedGroupCount
		{
			/*
		...
		internal int groupCount;
		internal int selectedGroupCount;
		internal System.Collections.BitArray bsSelectedGroups;
		...
		internal Chain(Frame frame, Model model, char chainID)
		{
			this.frame = frame;
			this.model = model;
		...
		internal Group getGroup(int groupIndex)
		{
		...
		internal int getNextSeqcodeIndex(int iStart, int seqcode)
		{
		...
		internal int getSelectedGroupIndex(Group group)
		{
