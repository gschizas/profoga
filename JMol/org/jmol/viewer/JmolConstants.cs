/* $RCSfile$
* $Author: nicove $
* $Date: 2006-04-14 20:06:13 +0200 (ven., 14 avr. 2006) $
* $Revision: 4977 $
*
...
namespace org.jmol.viewer
{
	...
	sealed public class JmolConstants
	{
		...
		public const System.String copyright = "(C) 2006 Jmol Development";
		public const System.String version = "10.2.0";
		public const System.String cvsDate = "$Date: 2006-04-14 20:06:13 +0200 (ven., 14 avr. 2006) $";
		...
		//UPGRADE_NOTE: Final was removed from the declaration of 'bondOrderNames'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		internal static readonly System.String[] bondOrderNames = new System.String[]{"single", "double", "triple", "aromatic", "hbond", "partial", "partialDouble"};
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'bondOrderValues '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		internal static readonly short[] bondOrderValues = new short[]{BOND_COVALENT_SINGLE, BOND_COVALENT_DOUBLE, BOND_COVALENT_TRIPLE, BOND_AROMATIC, BOND_H_REGULAR, BOND_PARTIAL01, BOND_PARTIAL12};
		...
		public static readonly int[] argbsChainHetero = new int[]{unchecked((int) 0xFFffffff), 0xFFC0D0FF - 0x00303030, 0xFFB0FFB0 - 0x00303018, 0xFFFFC0C8 - 0x00303018, 0xFFFFFF80 - 0x00303010, 0xFFFFC0FF - 0x00303030, 0xFFB0F0F0 - 0x00303030, 0xFFFFD070 - 0x00303010, 0xFFF08080 - 0x00303010, 0xFFF5DEB3 - 0x00303030, 0xFF00BFFF - 0x00001830, 0xFFCD5C5C - 0x00181010, 0xFF66CDAA - 0x00101818, 0xFF9ACD32 - 0x00101808, 0xFFEE82EE - 0x00301030, 0xFF00CED1 - 0x00001830, 0xFF00FF7F - 0x00003010, 0xFF3CB371 - 0x00081810, 0xFF00008B + 0x00000030, 0xFFBDB76B - 0x00181810, 0xFF006400 + 0x00003000, 0xFF800000 + 0x00300000, 0xFF808000 + 0x00303000, 0xFF800080 + 0x00300030, 0xFF008080 + 0x00003030, 0xFFB8860B + 0x00303008, 0xFFB22222 + 0x00101010};
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'FORMAL_CHARGE_COLIX_RED '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly short FORMAL_CHARGE_COLIX_RED = (short) elementSymbols.Length;
		//UPGRADE_NOTE: Final was removed from the declaration of 'FORMAL_CHARGE_COLIX_WHITE '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly short FORMAL_CHARGE_COLIX_WHITE = (short) (FORMAL_CHARGE_COLIX_RED + 4);
		//UPGRADE_NOTE: Final was removed from the declaration of 'FORMAL_CHARGE_COLIX_BLUE '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly short FORMAL_CHARGE_COLIX_BLUE = (short) (FORMAL_CHARGE_COLIX_WHITE + 7);
		public const int FORMAL_CHARGE_RANGE_SIZE = 12;
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'argbsFormalCharge'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly int[] argbsFormalCharge = new int[]{unchecked((int) 0xFFFF0000), unchecked((int) 0xFFFF4040), unchecked((int) 0xFFFF8080), unchecked((int) 0xFFFFC0C0), unchecked((int) 0xFFFFFFFF), unchecked((int) 0xFFD8D8FF), unchecked((int) 0xFFB4B4FF), unchecked((int) 0xFF9090FF), unchecked((int) 0xFF6C6CFF), unchecked((int) 0xFF4848FF), unchecked((int) 0xFF2424FF), unchecked((int) 0xFF0000FF)};
		
		public const int FORMAL_CHARGE_INDEX_WHITE = 4;
		//UPGRADE_NOTE: Final was removed from the declaration of 'FORMAL_CHARGE_INDEX_MAX '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly int FORMAL_CHARGE_INDEX_MAX = argbsFormalCharge.Length;
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'PARTIAL_CHARGE_COLIX_RED '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly short PARTIAL_CHARGE_COLIX_RED = (short) (FORMAL_CHARGE_COLIX_BLUE + 1);
		//UPGRADE_NOTE: Final was removed from the declaration of 'PARTIAL_CHARGE_COLIX_WHITE '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly short PARTIAL_CHARGE_COLIX_WHITE = (short) (PARTIAL_CHARGE_COLIX_RED + 15);
		//UPGRADE_NOTE: Final was removed from the declaration of 'PARTIAL_CHARGE_COLIX_BLUE '. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly short PARTIAL_CHARGE_COLIX_BLUE = (short) (PARTIAL_CHARGE_COLIX_WHITE + 15);
		public const int PARTIAL_CHARGE_RANGE_SIZE = 31;
		...
		//UPGRADE_NOTE: Final was removed from the declaration of 'argbsRoygbScale'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly int[] argbsRoygbScale = new int[]{unchecked((int) 0xFFFF0000), unchecked((int) 0xFFFF2000), unchecked((int) 0xFFFF4000), unchecked((int) 0xFFFF6000), unchecked((int) 0xFFFF8000), unchecked((int) 0xFFFFA000), unchecked((int) 0xFFFFC000), unchecked((int) 0xFFFFE000), unchecked((int) 0xFFFFF000), unchecked((int) 0xFFFFFF00), unchecked((int) 0xFFF0F000), unchecked((int) 0xFFE0FF00), unchecked((int) 0xFFC0FF00), unchecked((int) 0xFFA0FF00), unchecked((int) 0xFF80FF00), unchecked((int) 0xFF60FF00), unchecked((int) 0xFF40FF00), unchecked((int) 0xFF20FF00), unchecked((int) 0xFF00FF00), unchecked((int) 0xFF00FF20), unchecked((int) 0xFF00FF40), unchecked((int) 0xFF00FF60), unchecked((int) 0xFF00FF80), unchecked((int) 0xFF00FFA0), unchecked((int) 0xFF00FFC0), unchecked((int) 0xFF00FFE0), unchecked((int) 0xFF00FFFF), unchecked((int) 0xFF00E0FF), unchecked((int) 0xFF00C0FF), unchecked((int) 0xFF00A0FF), unchecked((int) 0xFF0080FF), unchecked((int) 0xFF0060FF), unchecked((int) 0xFF0040FF), unchecked((int) 0xFF0020FF), unchecked((int) 0xFF0000FF)};
		...
		*/
		...
		//UPGRADE_NOTE: Final was removed from the declaration of 'argbsIsosurfacePositive'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly int[] argbsIsosurfacePositive = new int[]{unchecked((int) 0xFF5020A0), unchecked((int) 0xFF7040C0), unchecked((int) 0xFF9060E0), unchecked((int) 0xFFB080FF)};
		
		//UPGRADE_NOTE: Final was removed from the declaration of 'argbsIsosurfaceNegative'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly int[] argbsIsosurfaceNegative = new int[]{unchecked((int) 0xFFA02050), unchecked((int) 0xFFC04070), unchecked((int) 0xFFE06090), unchecked((int) 0xFFFF80B0)};
		...
		public const sbyte ATOMID_C5_PRIME = 6;
		public const sbyte ATOMID_C3_PRIME = 8;
		...
		//UPGRADE_NOTE: Final was removed from the declaration of 'predefinedGroup1Names'. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1003'"
		public static readonly System.String[] predefinedGroup1Names = new System.String[]{"", "A", "R", "N", "D", "C", "Q", "E", "G", "H", "I", "L", "K", "M", "F", "P", "S", "T", "W", "Y", "V"};
		...
		public const int SHAPE_SASURFACE = 24;
		public const int SHAPE_ISOSURFACE = 25;
		public const int SHAPE_PRUEBA = 26;
		public const int SHAPE_MAX = 27;
		...
		public static readonly System.String[] shapeClassBases = new System.String[]{"Balls", "Sticks", "Hsticks", "Sssticks", "Labels", "Vectors", "Measures", "Dots", "Backbone", "Trace", "Cartoon", "Strands", "MeshRibbon", "Ribbons", "Rockets", "Stars", "Axes", "Bbcage", "Uccage", "Frank", "Echo", "Hover", "Pmesh", "Polyhedra", "Sasurface", "Isosurface", "Prueba"};
		
		////////////////////////////////////////////////////////////////
		// Stereo modes
		////////////////////////////////////////////////////////////////
		public const int STEREO_NONE = 0;
		public const int STEREO_DOUBLE = 1;
		public const int STEREO_REDCYAN = 2;
		public const int STEREO_REDBLUE = 3;
		public const int STEREO_REDGREEN = 4;
		static JmolConstants()
		{
			...
			// if they are false then the compiler should take them away
			{
				...
				{
					System.Console.Out.WriteLine("formal charge color table length");
					throw new System.NullReferenceException();
				}
