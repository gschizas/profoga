...
namespace org.openscience.jmol.app
{
	...
	[Serializable]
	public class WhatsNewDialog:System.Windows.Forms.Form
	{
		...
		{
			public AnonymousClassJScrollPane(WhatsNewDialog enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(WhatsNewDialog enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private WhatsNewDialog enclosingInstance;
			public WhatsNewDialog Enclosing_Instance
			{
				get
				{
			...
			{
				return new System.Drawing.Size(500, 400);
			}
		...
		{
			public AnonymousClassActionListener(WhatsNewDialog enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(WhatsNewDialog enclosingInstance)
		...
		public WhatsNewDialog(System.Windows.Forms.Form fr):base()
		{
			...
			SupportClass.DialogSupport.SetDialog(this, fr, GT._("What's New in Jmol"));
			...
			try
			{
				...
				System.Uri changeLogURL = this.GetType().getClassLoader().getResource(JmolResourceHandler.getStringX("WhatsNew.changeLogURL"));
				...
				else
				{
					...
					temp_richtextbox.Text = GT._("Unable to find url \"{0}\".", new System.Object[]{JmolResourceHandler.getStringX("WhatsNew.changeLogURL")});;
		...
		internal class PageLoader : IThreadRunnable
		{
			...
			internal PageLoader(WhatsNewDialog enclosingInstance, System.Uri u, System.Windows.Forms.Cursor c)
			{
				InitBlock(enclosingInstance);
				url = u;
				cursor = c;
