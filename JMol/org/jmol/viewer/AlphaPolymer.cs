...
namespace org.jmol.viewer
{
	...
	class AlphaPolymer:Polymer
	{
		...
		internal AlphaPolymer(Monomer[] monomers):base(monomers)
		{
		}
		
		internal override void  addSecondaryStructure(sbyte type, char startChainID, int startSeqcode, char endChainID, int endSeqcode)
		{
		...
		internal virtual void  addSecondaryStructure(sbyte type, int indexStart, int indexEnd)
		{
		...
		internal virtual void  calcHydrogenBonds()
		{
		}
		...
		internal const sbyte CODE_NADA = 0;
		internal const sbyte CODE_RIGHT_HELIX = 1;
		internal const sbyte CODE_BETA_SHEET = 2;
		internal const sbyte CODE_LEFT_HELIX = 3;
		
		internal const sbyte CODE_LEFT_TURN = 4;
		internal const sbyte CODE_RIGHT_TURN = 5;
		
		internal virtual float[] calculateAnglesInDegrees()
		{
		...
		internal virtual sbyte[] calculateCodes(float[] angles)
		{
		...
		internal virtual void  checkBetaSheetAlphaHelixOverlap(sbyte[] codes, float[] angles)
		{
		...
		internal static readonly sbyte TAG_NADA;
		...
		internal static readonly sbyte TAG_TURN;
		...
		internal static readonly sbyte TAG_SHEET;
		...
		internal static readonly sbyte TAG_HELIX;
		
		internal virtual sbyte[] calculateRunsFourOrMore(sbyte[] codes)
		{
		...
		internal virtual void  extendRuns(sbyte[] tags)
		{
		...
		internal virtual void  searchForTurns(sbyte[] codes, float[] angles, sbyte[] tags)
		{
			for (int i = monomerCount - 1; --i >= 2; )
			{
				codes[i] = CODE_NADA;
		...
		internal virtual void  addStructuresFromTags(sbyte[] tags)
		{
			int i = 0;
