...
namespace org.jmol.viewer
{
	...
	sealed class Mmset
	{
		...
		private System.String[] modelNames = new System.String[1];
		private int[] modelNumbers = new int[1];
		//UPGRADE_ISSUE: Class hierarchy differences between 'java.util.Properties' and 'System.Collections.Specialized.NameValueCollection' may cause compilation errors. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1186'"
		private System.Collections.Specialized.NameValueCollection[] modelProperties = new System.Collections.Specialized.NameValueCollection[1];
		...
		internal System.String getModelProperty(int modelIndex, System.String property)
		{
			//UPGRADE_ISSUE: Class hierarchy differences between 'java.util.Properties' and 'System.Collections.Specialized.NameValueCollection' may cause compilation errors. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1186'"
			System.Collections.Specialized.NameValueCollection props = modelProperties[modelIndex];
		...
		internal class Structure
		{
			...
			internal int startSeqcode;
			internal char endChainID;
			internal int endSeqcode;
			
			internal Structure(System.String typeName, char startChainID, int startSeqcode, char endChainID, int endSeqcode)
			{
