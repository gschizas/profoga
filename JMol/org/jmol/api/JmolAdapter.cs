...
namespace org.jmol.api
{
	...
	public abstract class JmolAdapter
	{
		...
		/// <summary> Associate a clientFile object with an array of BufferedReader.
		/// 
		...
		/// 
		/// </summary>
		/// <param name="name">File names, String or URL acting as the source of each reader
		/// </param>
		/// <param name="bufferedReader">The array of BufferedReader
		/// </param>
		/// <returns> The clientFile or String with an error message
		/// </returns>
		public virtual System.Object openBufferedReaders(System.String[] name, System.IO.StreamReader[] bufferedReader)
		{
		...
		/// <returns> The clientFile or String with an error message
		/// </returns>
		/// <seealso cref="openBufferedReaders(String[], BufferedReader[])">
		/// </seealso>
		public virtual System.Object openBufferedReaders(System.String[] name, System.IO.StreamReader[] bufferedReader, Logger logger)
		{
			return null;
		}
		
		public virtual System.Object openDOMReader(System.Object DOMNode)
		{
			return openDOMReader(DOMNode, null);
		}
		
		public virtual System.Object openDOMReader(System.Object DOMNode, Logger logger)
		{
			return null;
		}
		...
		//UPGRADE_NOTE: Field 'EnclosingInstance' was added to class 'Logger' to access its enclosing instance. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1019'"
		/// <summary> Logger that writes to stdout</summary>
		public class Logger
		{
			public Logger(JmolAdapter enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(JmolAdapter enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private JmolAdapter enclosingInstance;
			virtual public bool Logging
			{
				// default logger will log to stdout
			...
			public JmolAdapter Enclosing_Instance
			{
				get
				{
			...
			public virtual void  log(System.String str1)
			{
				System.Console.Out.WriteLine(Enclosing_Instance.adapterName + ":" + str1);
			}
			public virtual void  log(System.String str1, System.Object obj1)
			{
				//UPGRADE_TODO: The equivalent in .NET for method 'java.lang.Object.toString' may return a different value. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1043'"
				System.Console.Out.WriteLine(Enclosing_Instance.adapterName + ":" + str1 + ":" + obj1);
			}
			public virtual void  log(System.String str1, System.Object obj1, System.Object obj2)
			{
				//UPGRADE_TODO: The equivalent in .NET for method 'java.lang.Object.toString' may return a different value. "ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?index='!DefaultContextWindowIndex'&keyword='jlca1043'"
				System.Console.Out.WriteLine(Enclosing_Instance.adapterName + ":" + str1 + ":" + obj1 + ":" + obj2);
			}
		}
