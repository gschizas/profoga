...
namespace org.jmol.viewer
{
	...
	class MeshRibbonRenderer:MpsRenderer
	{
		// not current for Mcp class
		
		internal MeshRibbon strands;
		...
		internal virtual void  render1StrandSegment(int monomerCount, Monomer monomer, short colix, short[] mads, Point3i[] screens, int i)
		{
			...
			g3d.drawHermite(colix, 7, screens[iPrev], screens[i], screens[iNext], screens[iNext2]);
		}
		...
		internal virtual void  render2StrandSegment(int monomerCount, Monomer monomer, short colix, short[] mads, Point3i[] ribbonTopScreens, Point3i[] ribbonBottomScreens, int i)
		{
			...
			g3d.drawHermite(false, true, colix, isNucleicPolymer?4:7, ribbonTopScreens[iPrev], ribbonTopScreens[i], ribbonTopScreens[iNext], ribbonTopScreens[iNext2], ribbonBottomScreens[iPrev], ribbonBottomScreens[i], ribbonBottomScreens[iNext], ribbonBottomScreens[iNext2]);
		}
	}
}