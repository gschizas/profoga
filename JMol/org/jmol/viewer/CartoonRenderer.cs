...
namespace org.jmol.viewer
{
	...
	class CartoonRenderer:MpsRenderer
	{
		...
		internal virtual void  calc1Screen(Point3f center, Vector3f vector, short mad, float offsetFraction, Point3i screen)
		{
		...
		internal Point3i[] ribbonTopScreens;
		internal Point3i[] ribbonBottomScreens;
		...
		internal virtual void  render1Chain()
		{
			...
			for (int i = monomerCount; --i >= 0; )
				if (mads[i] > 0)
				{
					...
					short colix = Graphics3D.inheritColix(colixes[i], group.LeadAtom.colixAtom);
		...
		internal virtual void  render2StrandSegment(int monomerCount, Monomer group, short colix, short[] mads, int i)
		{
		...
		internal Point3i screenArrowTop = new Point3i();
		...
		internal Point3i screenArrowTopPrev = new Point3i();
		...
		internal Point3i screenArrowBot = new Point3i();
		...
		internal Point3i screenArrowBotPrev = new Point3i();
		
		internal virtual void  render2StrandArrowhead(int monomerCount, Monomer group, short colix, short[] mads, int i)
		{
			int iLast = monomerCount;
			int iPrev = i - 1;
			if (iPrev < 0)
		...
		internal Point3f[] ring6Points = new Point3f[6];
		...
		internal Point3i[] ring6Screens = new Point3i[6];
		...
		internal Point3f[] ring5Points = new Point3f[5];
		...
		internal Point3i[] ring5Screens = new Point3i[5];
		
		internal virtual void  renderNucleicBaseStep(NucleicMonomer nucleotide, short colix, short mad, Point3i backboneScreen)
		{
		...
		internal virtual void  renderRing6(short colix)
		{
		...
		internal virtual void  renderRing5()
		{
