...
namespace org.jmol.viewer
{
	...
	class NucleicPolymer:Polymer
	{
		...
		internal NucleicPolymer(Monomer[] monomers):base(monomers)
		{
		}
		
		internal virtual Atom getNucleicPhosphorusAtom(int monomerIndex)
		{
		...
		internal virtual void  lookForHbonds(NucleicPolymer other, System.Collections.BitArray bsA, System.Collections.BitArray bsB)
		{
		...
		internal virtual void  createHydrogenBond(Atom atom1, Atom atom2, System.Collections.BitArray bsA, System.Collections.BitArray bsB)
		{
