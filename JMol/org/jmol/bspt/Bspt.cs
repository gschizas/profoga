...
namespace org.jmol.bspt
{
	...
	public sealed class Bspt
	{
		...
		internal const int leafCountMax = 2;
		// this corresponds to the max height of the tree
		internal const int MAX_TREE_DEPTH = 100;
		...
		*/
		...
		/// <summary> Create a bspt with the specified number of dimensions. For a 3-dimensional
		...
		/// <summary> Iterate through all of your data points, calling addTuple</summary>
		/// <param name="tuple">
		/// </param>
		...
		/// <summary> prints some simple stats to stdout</summary>
		public void  stats()
		{
			System.Console.Out.WriteLine("bspt treeDepth=" + treeDepth + " count=" + eleRoot.count);
		}
