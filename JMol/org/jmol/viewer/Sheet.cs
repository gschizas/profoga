...
namespace org.jmol.viewer
{
	...
	{
		virtual internal Vector3f WidthUnitVector
		{
			get
			{
		...
		virtual internal Vector3f HeightUnitVector
		{
			get
			{
		...
		internal AminoPolymer aminoPolymer;
		internal Sheet(AminoPolymer aminoPolymer, int monomerIndex, int monomerCount):base(aminoPolymer, JmolConstants.PROTEIN_STRUCTURE_SHEET, monomerIndex, monomerCount)
		{
		...
		internal Vector3f widthUnitVector;
		internal Vector3f heightUnitVector;
		
		internal virtual void  calcSheetUnitVectors()
		{
			if (widthUnitVector == null)
			{
