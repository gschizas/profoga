...
namespace org.jmol.util
{
	...
	public class Int2ObjHash
	{
		...
		public virtual System.Object get_Renamed(int key)
		{
			lock (this)
			{
		...
		public virtual void  put(int key, System.Object value_Renamed)
		{
			lock (this)
			{
				Entry[] entries = this.entries;
		...
		internal class Entry
		{
			...
			internal Entry(int key, System.Object value_Renamed, Entry next)
			{
				this.key = key;
