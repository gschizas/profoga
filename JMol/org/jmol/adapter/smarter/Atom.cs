...
namespace org.jmol.adapter.smarter
{
	...
	class Atom : System.ICloneable
	{
		...
		internal virtual void  addVibrationVector(float vectorX, float vectorY, float vectorZ)
		{
		...
		internal static readonly int[] elementCharMasks = new int[]{1 << (int) ('c' - 'a') | 1 << (int) ('g' - 'a') | 1 << (int) ('l' - 'a') | 1 << (int) ('m' - 'a') | 1 << (int) ('r' - 'a') | 1 << (int) ('s' - 'a') | 1 << (int) ('t' - 'a') | 1 << (int) ('u' - 'a'), 1 << 31 | 1 << (int) ('a' - 'a') | 1 << (int) ('e' - 'a') | 1 << (int) ('h' - 'a') | 1 << (int) ('i' - 'a') | 1 << (int) ('k' - 'a') | 1 << (int) ('r' - 'a'), 1 << 31 | 1 << (int) ('a' - 'a') | 1 << (int) ('d' - 'a') | 1 << (int) ('e' - 'a') | 1 << (int) ('f' - 'a') | 1 << (int) ('l' - 'a') | 1 << (int) ('m' - 'a') | 1 << (int) ('o' - 'a') | 1 << (int) ('r' - 'a') | 1 << (int) ('s' - 'a') | 1 << (int) ('u' - 'a'), 1 << (int) ('b' - 'a') | 1 << (int) ('y' - 'a'), 1 << (int) ('r' - 'a') | 1 << (int) ('s' - 'a') | 1 << (int) ('u' - 'a'), 1 << 31 | 1 << (int) ('e' - 'a') | 1 << (int) ('m' - 'a') | 1 << (int) ('r' - 'a'), 1 << (int) ('a' - 'a') | 1 << (int) ('d' - 'a') | 1 << (int) ('e' - 'a'), 1 << 31 | 1 << (int) ('e' - 'a') | 1 << (int) ('f' - 'a') | 1 << (int) ('g' - 'a') | 1 << (int) ('o' - 'a') | 1 << (int) ('s' - 'a'), 1 << 31 | 1 << (int) ('n' - 'a') | 1 << (int) ('r' - 'a'), 0, 1 << 31 | 1 << (int) ('r' - 'a'), 1 << (int) ('a' - 'a') | 1 << (int) ('i' - 'a') | 1 << (int) ('r' - 'a') | 1 << (int) ('u' - 'a'), 1 << (int) ('d' - 'a') | 1 << (int) ('g' - 'a') | 1 << (int) ('n' - 'a') | 1 << (int) ('o' - 'a') | 1 << (int) ('t' - 'a'), 1 << 31 | 1 << (int) ('a' - 'a') | 1 << (int) ('b' - 'a') | 1 << (int) ('d' - 'a') | 1 << (int) ('e' - 'a') | 1 << (int) ('i' - 'a') | 1 << (int) ('o' - 'a') | 1 << (int) ('p' - 'a'), 1 << 31 | 1 << (int) ('s' - 'a'), 1 << 31 | 1 << (int) ('a' - 'a') | 1 << (int) ('b' - 'a') | 1 << (int) ('d' - 'a') | 1 << (int) ('m' - 'a') | 1 << (int) ('o' - 'a') | 1 << (int) ('r' - 'a') | 1 << (int) ('t' - 'a') | 1 << (int) ('u' - 'a'), 0, 1 << (int) ('a' - 'a') | 1 << (int) ('b' - 'a') | 1 << (int) ('e' - 'a') | 1 << (int) ('f' - 'a') | 1 << (int) ('h' - 'a') | 1 << (int) ('n' - 'a') | 1 << (int) ('u' - 'a'), 1 << 31 | 1 << (int) 
