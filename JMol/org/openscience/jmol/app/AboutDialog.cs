...
namespace org.openscience.jmol.app
{
	...
	public class AboutDialog:System.Windows.Forms.Form
	{
		...
		{
			public AnonymousClassJScrollPane(AboutDialog enclosingInstance)
			{
		...
		{
			public AnonymousClassActionListener(AboutDialog enclosingInstance)
			{
				InitBlock(enclosingInstance);
			}
			private void  InitBlock(AboutDialog enclosingInstance)
		...
		public AboutDialog(System.Windows.Forms.Form fr):base()
		{
			...
			SupportClass.DialogSupport.SetDialog(this, fr, GT._("About Jmol"));
			...
			try
			{
				...
				System.Uri aboutURL = this.GetType().getClassLoader().getResource(JmolResourceHandler.getStringX("About.aboutURL"));
				if (aboutURL != null)
				{
				...
				else
				{
					...
					temp_richtextbox.Text = GT._("Unable to find url \"{0}\".", new System.Object[]{JmolResourceHandler.getStringX("About.aboutURL")});;
		...
		internal class PageLoader : IThreadRunnable
		{
			...
			internal PageLoader(AboutDialog enclosingInstance, System.Uri u, System.Windows.Forms.Cursor c)
			{
				InitBlock(enclosingInstance);
				url = u;
				cursor = c;
