...
namespace org.jmol.viewer
{
	...
	class MeshRibbon:Mps
	{
		...
		{
			private void  InitBlock(MeshRibbon enclosingInstance)
			{
				this.enclosingInstance = enclosingInstance;
			}
			private MeshRibbon enclosingInstance;
			public MeshRibbon Enclosing_Instance
			{
				get
				{
			...
			internal Schain(MeshRibbon enclosingInstance, Polymer polymer):base(polymer, - 2, 3000, 800, 5000)
			{
