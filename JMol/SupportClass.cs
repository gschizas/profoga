...
public class BufferedStreamManager
{
	...
	/*******************************/
	/// <summary>
	/// Adds support for creating and managing TrackBar objects.
	/// </summary>
	public class TrackBarSupport
	{
		/// <summary>
		/// Creates a new TrackBar with the default values.
		/// </summary>
		/// <returns>The trackbar with its properties sets to the default values.</returns>
		public static System.Windows.Forms.TrackBar CreateTrackBar()
		{
		...
		/// <summary>
		/// Sets the properties of the specified trackbar to their default values
		/// </summary>
		/// <param name="trackbar">TrackBar to be modified</param>
		/// <returns>The trackbar with its properties sets to the default values.</returns>
		public static System.Windows.Forms.TrackBar SetTrackBar( System.Windows.Forms.TrackBar trackbar )
		{
			trackbar.Maximum = 100;
			trackbar.Value = 50;
			trackbar.TickFrequency = 0;
		...
		/// <summary>
		/// Creates a new TrackBar with the specified orientation and with the range 0 to 100 and
		/// an initial value of 50.
		/// </summary>
		/// <param name="orientation">One of the Orientation values, Orientation.HORIZONTAL or Orientation.VERTICAL.</param>
		/// <returns>The trackbar with its properties set to default values and the specified orientation.</returns>
		public static System.Windows.Forms.TrackBar CreateTrackBar(System.Windows.Forms.Orientation orientation)
		{
			System.Windows.Forms.TrackBar trackbar = TrackBarSupport.CreateTrackBar();
			trackbar.Orientation = orientation;
			return trackbar;
		}

		/// <summary>
		/// Sets the properties of the specified trackbar to default values and the orientation specified.
		/// </summary>
		/// <param name="trackbar">Trackbar to be modified</param>
		/// <param name="orientation">One of the Orientation values, Orientation.HORIZONTAL or Orientation.VERTICAL.</param>
		/// <returns>The trackbar with its properties set to default values and the specified orientation.</returns>
		public static System.Windows.Forms.TrackBar SetTrackBar( System.Windows.Forms.TrackBar trackbar, System.Windows.Forms.Orientation orientation )
		{
			trackbar = TrackBarSupport.SetTrackBar( trackbar );
			trackbar.Orientation = orientation;
			return trackbar;
		}

		/// <summary>
		/// Creates a new TrackBar with the specified range and some default values.
		/// </summary>
		/// <param name="minimum">The minimum value of the trackbar.</param>
		/// <param name="maximum">The maximum value of the trackbar.</param>
		/// <returns>The trackbar with its properties set to default values and the specified range.</returns>
		public static System.Windows.Forms.TrackBar CreateTrackBar(int minimum, int maximum)
		{
			System.Windows.Forms.TrackBar trackbar = TrackBarSupport.CreateTrackBar();
		...
		/// <summary>
		/// Sets the properties of the specified trackbar to default values and the specified minimum and maximum values.
		/// </summary>
		/// <param name="trackbar">Trackbar to be modified</param>
		/// <param name="minimum">The minimum value of the trackbar.</param>
		/// <param name="maximum">The maximum value of the trackbar.</param>
		/// <returns>The trackbar with its properties set to default values and the specified range.</returns>
		public static System.Windows.Forms.TrackBar SetTrackBar( System.Windows.Forms.TrackBar trackbar, int minimum, int maximum )
		{
			trackbar = TrackBarSupport.SetTrackBar( trackbar );
			trackbar.SetRange(minimum, maximum);
			return trackbar;
		...
		/// <summary>
		/// Creates a new TrackBar with the specified range and initial value.
		/// </summary>
		/// <param name="minimum">The minimum value of the trackbar.</param>
		/// <param name="maximum">The maximum value of the trackbar.</param>
		/// <param name="initialValue">The initial value of the trackbar.</param>
		/// <returns>The trackbar with its properties set to the specified values.</returns>
		public static System.Windows.Forms.TrackBar CreateTrackBar(int minimum, int maximum, int initialValue)
		{
			System.Windows.Forms.TrackBar trackbar = TrackBarSupport.CreateTrackBar(minimum, maximum);
			trackbar.Value = initialValue;
			return trackbar;
		}

		/// <summary>
		/// Sets the properties of the specified trackbar to the specified minimum, maximum and initial values.
		/// </summary>
		/// <param name="trackbar">Trackbar to be modified</param>
		/// <param name="minimum">The minimum value of the trackbar.</param>
		/// <param name="maximum">The maximum value of the trackbar.</param>
		/// <param name="initialValue">The initial value of the trackbar.</param>
		/// <returns>The trackbar with its properties set to the specified values.</returns>
		public static System.Windows.Forms.TrackBar SetTrackBar( System.Windows.Forms.TrackBar trackbar, int minimum, int maximum, int initialValue )
		{
			trackbar = TrackBarSupport.SetTrackBar( trackbar, minimum, maximum );
			trackbar.Value = initialValue;
			return trackbar;
		}

		/// <summary>
		/// Creates a new TrackBar with the specified values.
		/// </summary>
		/// <param name="orientation">One of the System.Windows.Forms.Orientation values, Orientation.HORIZONTAL or Orientation.VERTICAL.</param>
		/// <param name="minimum">The minimum value of the TrackBar.</param>
		/// <param name="maximum">The maximum value of the TrackBar.</param>
		/// <param name="initialValue">The initial value of the TrackBar.</param>
		/// <returns>The trackbar with its properties set to the specified values.</returns>
		public static System.Windows.Forms.TrackBar CreateTrackBar(System.Windows.Forms.Orientation orientation, int minimum, int maximum, int initialValue)
		{
			System.Windows.Forms.TrackBar trackbar = new System.Windows.Forms.TrackBar();
			trackbar.SetRange(minimum, maximum);
			trackbar.Orientation = orientation;
		...
		/// <summary>
		/// Sets the properties of the specified trackbar to the specified values
		/// </summary>
		/// <param name="trackbar">Trackbar to be modified</param>
		/// <param name="orientation">One of the System.Windows.Forms.Orientation values, Orientation.HORIZONTAL or Orientation.VERTICAL.</param>
		/// <param name="minimum">The minimum value of the TrackBar.</param>
		...
		/// <param name="initialValue">The initial value of the TrackBar.</param>
		/// <returns>The trackbar with its properties set to the specified values.</returns>
		public static System.Windows.Forms.TrackBar SetTrackBar( System.Windows.Forms.TrackBar trackbar, System.Windows.Forms.Orientation orientation, int minimum, int maximum, int initialValue )
		{
			trackbar = TrackBarSupport.SetTrackBar( trackbar, minimum, maximum, initialValue );
			trackbar.Orientation = orientation;
			return trackbar;
		}

		/// <summary>
		/// Change the TickStyle property of the specified trackbar depending on the boolean specified.
		/// </summary>
		/// <param name="trackbar">Trackbar to be modified</param>
		/// <param name="paintTickMarks">A value indicating if tick marks are to be painted</param>
		/// <returns>The specified TrackBar with the TickStyle property changed</returns>
		public static System.Windows.Forms.TrackBar SetPaintTicks( System.Windows.Forms.TrackBar trackbar, bool paintTickMarks )
		{
			if ( paintTickMarks )
				trackbar.TickStyle = System.Windows.Forms.TickStyle.BottomRight;
			else
				trackbar.TickStyle = System.Windows.Forms.TickStyle.None;
			return trackbar;
		}
		...
		/// <summary>
		/// Gets a value indicating if the tick marks are painted or not on the specified TrackBar
		/// </summary>
		/// <param name="trackbar">Trackbar from which the information is obtained</param>
		/// <returns>True if the tick marks are painted on the trackbar, false otherwise</returns>
		public static bool GetPaintTicks( System.Windows.Forms.TrackBar trackbar )
		{
			return !( trackbar.TickStyle == System.Windows.Forms.TickStyle.None );
		}
	}
	/*******************************/
	/// <summary>
	...
	/*******************************/
	/// <summary>
	/// Support class to adding check box functionallity in menu items.
	/// </summary>
	public class CheckBoxMenuItemSupport
	{
		/// <summary>
		/// Creates a new menu item with the specified text and the specified checked state.
		/// </summary>
		/// <param name="text">The text to show in the menu item.</param>
		/// <param name="isChecked">The state of the Checked property.</param>
		/// <returns>A new menu item with the text and checked specified.</returns>
		public static System.Windows.Forms.MenuItem CreateCheckBoxMenu(System.String text, bool isChecked)
		{
			System.Windows.Forms.MenuItem CheckBoxMenuItem = new System.Windows.Forms.MenuItem(text);
			CheckBoxMenuItem.Checked = isChecked;
			return CheckBoxMenuItem;
		}

		/// <summary>
		/// Sets a menu item with the specified text and the specified checked state.
		/// </summary>
		/// <param name="item">The menu item to set with the values.</param>
		/// <param name="text">The text to show in the menu item.</param>
		/// <param name="isChecked">The state of the Checked property.</param>
		/// <returns>A new menu item with the text and checked specified.</returns>
		public static void SetCheckBoxMenu(System.Windows.Forms.MenuItem item, System.String text, bool isChecked)
		{
			item.Text = text;
		...
		/// <summary>
		/// Returns an array containing the text of the item if checked, or null otherwise.
		/// </summary>
		/// <param name="item">The menu item to verify if it is checked.</param>
		/// <returns>An array of length 1 with the text of the menu item or null.</returns>
		public static System.Object[] GetSelectedObjects(System.Windows.Forms.MenuItem item)
		{
			System.Object[] Objects = new System.Object[1];
			Objects[0] = item.Checked ? item.Text : null;
			return Objects;
		}
	}
