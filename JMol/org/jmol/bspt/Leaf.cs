...
namespace org.jmol.bspt
{
	...
	/// <summary> A leaf of Tuple objects in the bsp tree
	/// 
	/// </summary>
	...
	class Leaf:Element
	{
		...
		internal Leaf(Bspt bspt, Leaf leaf, int countToKeep):this(bspt)
		{
		...
		internal virtual void  sort(int dim)
		{
			for (int i = count; --i > 0; )
			{
				// this is > not >=
