...
namespace org.jmol.g3d
{
	...
	class Cylinder3D
	{
		...
		internal Cylinder3D(Graphics3D g3d)
		{
			this.g3d = g3d;
		}
		...
		internal virtual void  render(short colixA, short colixB, sbyte endcaps, int diameter, int xA, int yA, int zA, int xB, int yB, int zB)
		{
		...
		internal virtual void  generateBaseEllipse()
		{
		...
		internal virtual bool isFullyClipped(int diameter, int xA, int yA, int zA, int xB, int yB, int zB)
		{
			// miguel 2006 03 25
		...
		internal virtual void  interpolate(int iLower, int iUpper)
		{
		...
		internal virtual void  plotRaster(int i)
		{
		...
		internal virtual int[] realloc(int[] a)
		{
			int[] t;
		...
		internal virtual float[] realloc(float[] a)
		{
			float[] t;
		...
		internal virtual int allocRaster()
		{
		...
		internal virtual void  calcRotatedPoint(float t, int i)
		{
			tRaster[i] = t;
		...
		internal virtual void  findMinMaxY()
		{
			yMin = yMax = yRaster[0];
			for (int i = rasterCount; --i > 0; )
			{
		...
		internal virtual void  findMinMaxX(int y)
		{
		...
		internal virtual void  renderFlatEndcap(bool tCylinder)
		{
		...
		internal virtual void  renderSphericalEndcaps()
		{
		...
		internal virtual void  renderCone(short colix, sbyte endcap, int diameter, int xA, int yA, int zA, int xTip, int yTip, int zTip)
		{
		...
		internal virtual void  plotRasterCone(int i)
		{
			int x = xRaster[i];
			int y = yRaster[i];
			int z = zRaster[i];
		...
		internal virtual void  calcArgbEndcap(bool tCylinder)
		{
			tEndcapOpen = false;
