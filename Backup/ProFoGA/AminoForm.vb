...
#End Region
	Private amino1 As New AminoMol.Amino
	Private amino2 As New AminoMol.Amino

	Private Sub btnOpen_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)
		Dim amino As New AminoMol.Amino
	...
	Private Sub LoadAndPaintAmino(ByRef amino As AminoMol.Amino)
		If fdlgOpenAmino.ShowDialog = DialogResult.OK Then
			amino.Open(fdlgOpenAmino.FileName)
			...
			Next y, x
			amino.DisplayOptions = AminoMol.Amino.AtomDisplayOptions.Atoms
			amino.Display(System.Drawing.Graphics.FromImage(pbDisplay.Image))
		End If

		Dim txtOut As New System.Text.StringBuilder

		Dim s As New XmlSerializer(GetType(AminoMol.Amino))
